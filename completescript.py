...
l=[]  #make sure you declare this out of forr loop 

for page in range(0,int(page_nr)*10,10):
    #print("http://www.pyclass.com/real-estate/rock-springs-wy/LCWYROCKSPRINGS/t=0&s="+str(page)+".html")
    #make sure you add headers
